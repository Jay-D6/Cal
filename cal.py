...
root = tk.Tk()
root.geometry("350x275")  # Increase the width of the window 

text_result = tk.Text(root, height=2, width=20, font="Arial, 18")  # Increase the width of the text box
text_result.grid(columnspan=5)

# Buttons for the GUI calculator
...
btn_times = tk.Button(root, text="x", command=lambda: add_to_calculation("x"), width=5, font=("Arial", 15))
...
btn_divide = tk.Button(root, text="/", command=lambda: add_to_calculation("/"), width=5, font=("Arial", 15))
...
btn_equal = tk.Button(root, text="=", command= evaluate_calculation, width=11, font=("Arial", 15))
